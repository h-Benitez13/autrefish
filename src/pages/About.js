      ...
      <Container>
        ...
        <div className="uk-container uk-position-small uk-position-center">
          <h1
            ...
            uk-scrollspy="cls: uk-animation-slide-left; delay: 800; repeat: true"
          >
            Autre
          </h1>
          <h1
            className="uk-heading-large uk-light"
            uk-scrollspy="cls: uk-animation-slide-right; delay: 800; repeat: true"
          >
            Fish
          </h1>
        </div>
            ...
            <article className="uk-article">
              ...
              <div className="uk-card-body">
                <p className="uk-article-meta">
                  Written by Whatthehec on 7 May 2019. Posted in Blog
                </p>

                <p className="uk-text-lead">Mission, Objective, Who are we? </p>
