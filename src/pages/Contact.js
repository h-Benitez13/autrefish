                ...
                <Input>
                    ...
                    <div className="uk-margin-medium">
                        <div className=" uk-inline">
                            ...
                            <input id="form-stacked-first" className="uk-input uk-form-input-width-1-2 uk-form-large uk-form-blank" type="text" />
                        </div>
                        {/* last name */}
                        <div className=" uk-inline">
                            ...
                            <input id="form-stacked-last" className="uk-input uk-form-input-width-1-2 uk-form-large uk-form-blank" type="text" />
                        </div>
                    </div>
                    {/* email */}
                    <div className="uk-margin-medium">
                            ...
                            <input className="uk-input uk-form-input-width-1-2 uk-form-large uk-form-blank" type="email" />
                    ...
                    <div className="uk-margin">
                            ...
                            <input className="uk-input uk-form-input-width-1-2 uk-form-large uk-form-blank" type="text" placeholder="Project for Hire!" />
                    ...
                    <div className="uk-margin">
                        ...
                        <textarea className="uk-textarea uk-form-blank" rows="5" placeholder="Hi! I loved the website and projects, would love to collab/hire AutreFish"></textarea> 
                    </div>
                    {/* submit button */}
                    <div className="uk-margin ">
